...
<GetPromotionRulesRequest xmlns="urn:ebay:apis:eBLBaseComponents">
{{#params}}
    ...
    {{#PromotionMethod}}<PromotionMethod>{{PromotionMethod}}</PromotionMethod>{{/PromotionMethod}}
    {{#StoreCategoryID}}<StoreCategoryID>{{StoreCategoryID}}</StoreCategoryID>{{/StoreCategoryID}}
{{/params}}
